...
<form name="loginform" method="post" action={'/ybuser/login/'|ezurl}>
...
<div class="block">
    <label for="id3">{'YubiKey OTP (if set in your profile)'|i18n( 'design/admin/user/login' )}:</label>
    <input class="halfbox yubiKeyInput" type="password" size="10" name="YubiKey" id="id3" value="" tabindex="1" title="{'Insert your YubiKey and press on its button.'|i18n( 'design/admin/user/login' )}" />
</div>

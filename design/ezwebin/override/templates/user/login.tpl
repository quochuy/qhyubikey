...
<form method="post" action={"/ybuser/login/"|ezurl} name="loginform">
...
<div class="block">
<label for="id3">{"YubiKey Key"|i18n("design/standard/user/login")}</label><div class="labelbreak"></div>
<input class="halfbox" type="password" size="10" name="YubiKey" id="id3" value="" tabindex="1" />
</div>
